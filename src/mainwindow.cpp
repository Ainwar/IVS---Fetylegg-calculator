...
/*
 *  MainWindow::on_pushButton_help_clicked shows/hides labels with keybinding when "?" button is clicked
 */
...
/*
 *  MainWindow::on_pushButton_eq_pressed changing color of "=" button when pressed
 */
...
/*
 *  MainWindow::on_pushButton_eq_released changing back color of "=" button when released
 */
...
/*
 *  MainWindow::numbers_clicked inserting text of button when clicked on button from number buttongroup
...
/*
 *  MainWindow::numbers_pressed changing color of number buttons when pressed
 * @param button pointer to button from group numbers
 */
...
/*
 *  MainWindow::numbers_released changing back color of number buttons when released
 *  button pointer to button from group numbers
 */
...
/*
 *  MainWindow::light_grey_pressed changing color of light grey buttons when pressed
 *  button pointer to button from group light_grey_buttons
 */
...
/*
 *  MainWindow::light_grey_released changing back color of light grey button when released
 *  button pointer to button from group light_grey_buttons
 */
...
/*
 *  MainWindow::on_pushButton_del_clicked deletes previous char in textedit
 */
...
/*
 *  MainWindow::on_pushButton_c_clicked clears all text in textedit and textbrowser
 */
...
/*
 *  MainWindow::on_pushButton_ans_clicked prints last answer into textedit
 */
...
/*
 *  MainWindow::on_pushButton_neg_clicked negates whole string in textedit by
...
/*
 *  MainWindow::on_pushButton_dec_clicked prints decimal point into textedit
 */
...
/*
 *  MainWindow::operations_clicked prints operators "+","-","*","/" into textedit
 *  button pointer to button from group operations
 */
...
/*
 *  MainWindow::operations_pressed changing color of operations group button when pressed
 *  button pointer to button from group operations
 */
...
/*
 *  MainWindow::operations_released changing color of operations group button when released
 *  button pointer to button from group operations
 */
...
/*
 *  MainWindow::operations_x_pressed changing color of operations_x group button when pressed
 *  button pointer to button from group operations_x
 */
...
/*
 *  MainWindow::operations_x_released changing color of operations_x group button when released
 *  button pointer to button from group operations_x
 */
...
/*
 *  MainWindow::on_pushButton_sq_clicked inserts "^2" into textedit
 */
...
/*
 *  MainWindow::on_pushButton_sqn_clicked inserts "^()" into textedit
 */
...
/*
 *  MainWindow::on_pushButton_r_clicked inserts "√" into textedit
 */
...
/*
 *  MainWindow::on_pushButton_fac_clicked inserts "!" into textedit
 */
